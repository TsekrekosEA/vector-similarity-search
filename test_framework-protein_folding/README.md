...
```
test_framework-protein_folding/
...
```bash
# Navigate to project
cd vector-similarity-search/test_framework-protein_folding
...
# 3. Download Swiss-Prot (if not using setup.sh)
...
# 5. Build C++ components
cd ../algorithms/lsh-hypercube-ivf && make && cd ../test_framework-protein_folding
...
- **Part 1** (`../algorithms/lsh-hypercube-ivf/`): C++ implementation of LSH and Hypercube
- **Part 2** (`../algorithms/neural_lsh/`): Neural LSH implementation with KaHIP
